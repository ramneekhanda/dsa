...
export const tutorialChapters: TutorialChapter[] = [
  {
    ...
    lessons: [
      ...
      {
        id: "1.3",
        title: "1.3 Message Passing & Links",
      ...
      {
        id: "1.5",
        title: "1.5 Persistent State & Logging",
        markdown: "05_state_and_logging.md",
        yaml: "05_state_and_logging.yml",
      },
      {
        id: "1.6",
        title: "1.6 Multilevel Routing & Reverse Paths",
        markdown: "06_multilevel_routing.md",
        yaml: "06_multilevel_routing.yml",
      },
      {
        id: "1.7",
        title: "1.7 Interactive Narration (explain)",
  ...
  {
    id: "ch3",
    title: "Chapter 3: Custom Visuals & Node Overlays",
    dir: "ch3",
    lessons: [
      {
        id: "3.1",
        title: "3.1 draw() Basics & Node Coordinates",
        markdown: "01_draw_basics.md",
        yaml: "01_draw_basics.yml",
      },
      {
        id: "3.2",
        title: "3.2 Shape Primitives",
        markdown: "02_shapes.md",
        yaml: "02_shapes.yml",
      },
      {
        id: "3.3",
        title: "3.3 Reusable Node Templates",
        markdown: "03_node_templates.md",
        yaml: "03_node_templates.yml",
      },
      {
        id: "3.4",
        title: "3.4 Live State Gauges & Meters",
        markdown: "04_state_gauges.md",
        yaml: "04_state_gauges.yml",
      },
    ],
  },
  {
    id: "ch4",
    title: "Chapter 4: Theming & Visual Styling",
    dir: "ch4",
    lessons: [
      {
        id: "4.1",
        title: "4.1 Cloud Architecture Theme",
        markdown: "01_cloud_cards.md",
        yaml: "01_cloud_cards.yml",
      },
      {
        id: "4.2",
        title: "4.2 Datacenter Rack Units",
        markdown: "02_datacenter_rack.md",
        yaml: "02_datacenter_rack.yml",
      },
      {
        id: "4.3",
        title: "4.3 Cyberpunk Neon HUD",
        markdown: "03_cyberpunk_hud.md",
        yaml: "03_cyberpunk_hud.yml",
      },
      {
        id: "4.4",
        title: "4.4 Minimal Capsule Pills",
        markdown: "04_capsule_pills.md",
        yaml: "04_capsule_pills.yml",
      },
      {
        id: "4.5",
        title: "4.5 Layered & Composed Themes",
  ...
  {
    id: "ch5",
    title: "Chapter 5: Distributed Algorithms & plibs",
    dir: "ch5",
    lessons: [
      {
        id: "5.1",
        title: "5.1 Introduction to plibs",
        markdown: "01_intro_to_plibs.md",
        yaml: "01_intro_to_plibs.yml",
      },
      {
        id: "5.2",
        title: "5.2 Token Ring Mutual Exclusion",
        markdown: "02_token_ring.md",
        yaml: "02_token_ring.yml",
      },
      {
        id: "5.3",
        title: "5.3 Load Balancer (Round-Robin)",
        markdown: "03_load_balancer.md",
        yaml: "03_load_balancer.yml",
      },
      {
        id: "5.4",
        title: "5.4 Two-Phase Commit (2PC)",
        markdown: "04_two_phase_commit.md",
        yaml: "04_two_phase_commit.yml",
      },
      {
        id: "5.5",
        title: "5.5 Primary-Backup Replication",
        markdown: "05_primary_backup.md",
        yaml: "05_primary_backup.yml",
      },
      {
        id: "5.6",
        title: "5.6 AWS Cloud Architecture Library",
        markdown: "06_aws_cloud_architecture.md",
        yaml: "06_aws_cloud_architecture.yml",
      },
    ],
  },
];
